...
let data = [
  ...
  },
  {
    ...
    "category": {
      ...
      "creationAt": "2026-02-01T19:33:13.000Z",
      "updatedAt": "2026-02-01T19:33:13.000Z"
    },
    "images": [
      "https://placehold.co/600x400"
    ],
    "creationAt": "2026-02-01T22:00:20.000Z",
    "updatedAt": "2026-02-01T22:00:20.000Z"
  },
  {
    "id": 54,
    "title": "string",
    ...
    "category": {
      ...
      "creationAt": "2026-02-01T22:01:05.000Z",
...
router.get('/', function (req, res, next) {
  ...
  let result = data.filter(function (e) {
    ...
    if (slugQ) return e.slug === slugQ;
    return e.title.includes(titleQ) && e.price >= minPrice && e.price <= maxPrice;
  });
...
router.get('/slug/:slug', function (req, res, next) {
  ...
  console.log('requested slug:', s);
  console.log('available slugs count:', data.length);
  let result = data.find(function (e) {
    return e.slug === s && (!e.isDeleted);
  });
  if (result) {
    console.log('slug found for id:', result.id);
    res.send(result);
  } else {
